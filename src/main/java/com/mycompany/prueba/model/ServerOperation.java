...
public class ServerOperation extends UnicastRemoteObject implements RMIInterface {
    ...
    public JugadorVO getPlayer(String id) throws RemoteException {
        ...
        return MainDataBase.findJugadorById(DataBaseObjective.ORACLE,dbi,
                new JugadorVO(id));
    }

    @Override
    public PersonajeVO getCharacter(String id) throws RemoteException {
        return MainDataBase.findPersonajeById(DataBaseObjective.ORACLE,dbi,
                new PersonajeVO(id));
    }

    @Override
    public EspecieVO getSort(String id) throws RemoteException {
        return MainDataBase.findEspecieById(DataBaseObjective.ORACLE,dbi,
                new EspecieVO(id));
    }
  ...
  @Override
    ...
    public List<JugadorVO> getPlayers() throws RemoteException {
        return MainDataBase.listJugador(DataBaseObjective.ORACLE,dbi);
    }

    @Override
    public List<PersonajeVO> getCharacters() throws RemoteException {
        return MainDataBase.listPersonaje(DataBaseObjective.ORACLE,dbi);
    }

    @Override
    public List<EspecieVO> getSorts() throws RemoteException {
        return MainDataBase.listEspecie(DataBaseObjective.ORACLE,dbi);
    }
    @Override
    public List<PersonajeVO> getCharactersByPlayer(PersonajeVO player) throws RemoteException {
        return MainDataBase.listPersonajesSegunJugador(DataBaseObjective.ORACLE,dbi, player);
    }
}
